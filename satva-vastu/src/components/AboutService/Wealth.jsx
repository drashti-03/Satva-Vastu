    ...
    <>
      ...
      <div className="vastu-section container d-flex flex-column flex-lg-row align-items-center">
        <div className="vastu-image">
          <img
            src="\assets\images\wealth-main.png"
            alt="Vastu Diagram"
            className="vastu-diagramm d-flex "
          />
        </div>
        <div className="vastu-text">
          <h3 className="subheading">Wealth</h3>
          <p className="para">
            Want to attract financial stability and success? Vastu can guide you
            in setting up your space to invite wealth and prosperity into your
            life.
          </p>
          <p className="aims-title">
            Vastu regarding any Wealth issues aims to
          </p>
          <ul className="aims">
            <li>
              <svg
